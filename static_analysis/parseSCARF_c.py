...
for severity in [1,0,-1]:
  ...
  #    print(child1.tag, child1.attrib)
    ...
    for child2 in child1:
      if (child2.tag == "BugLocations"):
      ...
      elif (child2.tag == 'BugGroup'):   # not 'BugSeverity'):
        ...
        if(child2.text.lower() == "error"):
          bug_severity = 1
        elif(child2.text.lower() == "warning"):
          bug_severity = 0
#        elif((child2.text.lower() == "style") or (child2.text == "Warning")):
        elif(child2.text.lower() == "style"):
          bug_severity = -1
